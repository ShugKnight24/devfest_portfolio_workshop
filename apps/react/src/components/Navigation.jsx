  ...
  const linkClass = ({ isActive }) =>
    `px-3.5 py-1.5 rounded-lg text-xs font-semibold font-mono tracking-wide transition-all flex items-center gap-1.5 whitespace-nowrap cursor-pointer ${
      isActive
        ...
        : "text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700/80 hover:text-gray-900 dark:hover:text-white"
    }`;
    ...
    return (
      <button
        ...
        className={`fixed ${getMobileButtonPosition()} z-60 
          px-3.5 py-1.5 bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-full shadow-lg border border-gray-200 dark:border-gray-700
    ...
    <>
      ...
      <nav
        ...
        className={`fixed ${getDesktopPositionClasses()} z-60 
          ...
          rounded-2xl shadow-xl border border-gray-200/80 dark:border-gray-800/80
      ...
      >
                ...
                <div key={group.id} className="relative">
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-lg text-xs font-semibold font-mono tracking-wide transition-all flex items-center gap-1 cursor-pointer select-none ${
                      isGroupActive
                        ? "bg-(--color-primary)/20 text-gray-900 dark:text-white border border-(--color-primary)/40"
                  ...
                  {isOpen && (
                    <div
                      className={`absolute z-70 bg-white/95 dark:bg-gray-900/95 backdrop-blur-2xl rounded-2xl shadow-2xl border border-gray-200/80 dark:border-gray-800 p-2 min-w-[240px] animate-fade-in ${
                        verticalPos === "top"
        ...
        <div
          className={
            isVerticalLayout
              ? "h-px w-full bg-gray-200 dark:bg-gray-800 my-1"
              : "w-px h-6 bg-gray-200 dark:bg-gray-800 mx-1"
          }
        />
        ...
        <div className="relative">
          <button
            ...
            className={`${
              isVerticalLayout ? "w-full justify-center" : ""
            } p-1.5 rounded-lg transition-all cursor-pointer flex items-center gap-1.5 focus-visible:ring-2 focus-visible:ring-blue-500 ${
              showSettings
          ...
          {showSettings && (
            <div
              className={`absolute z-70 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-xl shadow-xl border border-gray-200 dark:border-gray-800 p-2.5 min-w-[200px]
                ${
                  isVerticalLayout
                    ? horizontalPos === "left"
      ...
      <div className="md:hidden">
        ...
        <button
          ...
          className={`fixed ${getMobileButtonPosition()} z-70 
            p-2.5 bg-white/90 dark:bg-gray-900/90 backdrop-blur-md rounded-full shadow-lg border border-gray-200 dark:border-gray-800
            text-gray-700 dark:text-gray-300 transition-all hover:scale-105 cursor-pointer focus-visible:ring-2 focus-visible:ring-blue-500`}
        ...
        <div
          className={`${
            drawerClasses.panel
          } bg-white/95 dark:bg-gray-900/95 backdrop-blur-2xl shadow-2xl border-gray-200 dark:border-gray-800 overflow-y-auto max-h-screen
        ...
        >
          ...
          <div className="p-4 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between">
            <h2 className="font-bold font-mono text-sm uppercase tracking-wider text-gray-900 dark:text-gray-100">
              Workshop Navigation
            </h2>
            <button
              onClick={() => setIsMobileMenuOpen(false)}
              className="p-1.5 text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 cursor-pointer"
