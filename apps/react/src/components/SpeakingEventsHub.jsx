  ...
  return (
    <section aria-labelledby="speaking-events-heading" className="w-full my-8">
      <div className="flex flex-col md:flex-row items-start md:items-end justify-between mb-8 pb-4 border-b border-gray-200 dark:border-gray-800 gap-4">
        <div>
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 text-blue-800 dark:text-blue-400 text-xs font-semibold uppercase tracking-wider mb-2">
          ...
          return (
            <div
              ...
              className={`rounded-2xl p-6 border flex flex-col justify-between transition-all duration-300 hover:shadow-xl ${
                isUpcoming
                  ? "bg-white dark:bg-gray-900/80 dark:bg-gradient-to-b dark:from-blue-900/10 dark:via-gray-900/40 dark:to-gray-900/90 border-blue-500/40 hover:border-blue-400"
                  : "bg-gray-50 dark:bg-gray-900/40 border-gray-200 dark:border-gray-800 dark:opacity-80 dark:hover:opacity-100"
              }`}
            >
              <div>
                {/* Top badges */}
                <div className="flex items-center justify-between gap-2 mb-4">
                  ...
                  <span className="text-xs font-mono font-medium text-gray-600 dark:text-gray-400 flex items-center gap-1">
                ...
                <p className="text-sm font-medium text-amber-800 dark:text-amber-300 mb-3 italic">
                  "{event.topic}"
                </p>
